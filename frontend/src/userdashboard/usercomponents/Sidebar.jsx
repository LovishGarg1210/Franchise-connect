...
const Sidebar = ({setIsOpen,isOpen}) => {
  ...
  return (
    <div className={`min-h-screen md:static absolute top-0 -left-20 bg-gray-900  text-white transition-all duration-300 ${isOpen ? ' w-full md:w-64 w-full z-50 -left-0 ' : 'w-20'}`} onClick={() => setIsOpen(!isOpen)} >
